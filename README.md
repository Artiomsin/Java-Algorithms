...
### 5.2 Trie-деревья
  ...
  4) Задание 5.2.20 [Директория](5.2/task_20/scr/org/example) (PLAN: 0.3 FACT: 0.4)
     + **Условие:**
     Наличие префикса. Добавьте в класс StringSET (см. упражнение 5.2.6) метод containsPrefix(), который принимает в качестве аргумента строку s и воз-
     вращает t r u e , если множество содержит строку с префиксом s.
