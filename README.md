...
### 5.4 Регулярные выражения
  1) Задание 5.4.17 [Директория](5.4/task_17/scr/org/example) (PLAN: 1 FACT:1.55)
     + **Условие:**
     Обобщенные символы. Добавьте в класс NFA обработку обобщенных символов.

  2) Задание 5.4.18 [Директория](5.4/task_18/scr/org/example) (PLAN: 1 FACT: 1.4)
     + **Условие:**
     Один или несколько. Добавьте в класс NFA обработку операции замыкания +.

  3) Задание 5.4.19 [Директория](5.4/task_19/scr/org/example) (PLAN: 0.5 FACT: 0.5)
     + **Условие:**
     Заданное множество. Добавьте в класс NFA обработку описателей заданного
     множества.

  4) Задание 5.4.20 [Директория](5.4/task_20/scr/org/example) (PLAN: 0.5 FACT: 1.25)
     + **Условие:**
