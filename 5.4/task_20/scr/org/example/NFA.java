...
class NFA {
    ...
    /**
     * Добавляет переход для данного состояния и диапазона символов.
     *
     * @param state     текущее состояние.
     * @param start     начальный символ диапазона.
     * @param end       конечный символ диапазона.
     * @param nextState следующее состояние.
     */
    public void addRangeTransition(int state, char start, char end, int nextState) {
